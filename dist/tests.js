...
arr = [1, 2, 3, 4, 5, 6];
moveByIndex(1, 4, arr);
if (arraysMatch(arr, [1, 3, 4, 5, 2, 6]))
...
arr = ['a', 'b', 'c', 'd', 'e', 'f'];
moveByIndex(1, 3, arr);
if (arraysMatch(arr, ['a', 'c', 'd', 'b', 'e', 'f']))
...
arr = [1, 2, 3, 4, 5, 6];
moveByIndex(-1, 3, arr);
if (arraysMatch(arr, [1, 2, 3, 6, 4, 5]))
...
arr = [[1, 2], [3, 4], [5, 6]];
moveByIndex(-1, -2, arr);
if (arraysMatch(arr, [[1, 2], [5, 6], [3, 4]]))
